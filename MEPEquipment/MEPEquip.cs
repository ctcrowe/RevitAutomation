...
namespace MEPEquipment
{
    public static class MEPEquip
    {
        ...
        {
            var assembly = typeof(MEPEquip).GetTypeInfo().Assembly;
            return assembly.GetManifestResourceNames().Any(x => x.Contains(id));
        }

        public static void LoadMEPEquipment(this Document doc)
        {
