...
/*
    ...
    internal class AlphaFilter3 : IAlphaFilter
    {
        ...
        internal AlphaFilter3(WriteToCMDLine write)
        {
            ...
            Networks[0].Layers.Add(new Layer(500, Networks[0].Layers.Last(), Activation.LRelu, 1e-5, 1e-5));
            Networks[0].Layers.Add(new Layer(500, Networks[0].Layers.Last(), Activation.LRelu, 1e-5, 1e-5));
            Networks[0].Layers.Add(new Layer(Size, Networks[0].Layers.Last(), Activation.LRelu, 1e-5, 1e-5));
            Networks[1].Layers.Add(new Layer(100, CharSet.CharCount * (1 + (2 * 5)), Activation.LRelu));
        ...
        public double[][][][][] Forward(string s)
        {
            ...
            Parallel.For(0, s.Length, j =>
            {
                ...
                output[1][j][0][0] = s.Locate(j, 5, true);
