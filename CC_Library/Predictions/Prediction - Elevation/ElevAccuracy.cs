...
{
    internal static class ElevationAccuracy
    {
        public static double[] ElevAccuracy
            ...
            List<string> Words)
        {
            ...
            Parallel.For(0, Entries.Count(), i =>
            {
                ...
                var result = Entries[i].ElevInput(new List<string>());
        ...
        public static void ElevAcc_Output
            (this List<Entry> Entries,
            NeuralNetwork Network,
            List<string> Words,
            bool tf)
