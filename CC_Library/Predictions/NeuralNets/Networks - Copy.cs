    ...
    public static class NeuralNets
    {
        public static NeuralNetwork NewNeuralNet(this Datatype datatype)
        {
            switch(datatype)
            {
                ...
                case Datatype.GlobalContext:
                    return GlobalContextNetwork();
        ...
        private static NeuralNetwork GlobalContextNetwork()
        {
            NeuralNetwork network = new NeuralNetwork();
            network.Layers.Add(new Layer(Alpha.PhraseLength, Alpha.PhraseLength, Activation.SoftMax));
            network.Datatype = Datatype.GlobalContext;
            return network;
        }
